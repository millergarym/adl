...
use adl_core::adlgen::adlc::workspace::{TypescriptGenOptions, TsRuntimeOpt, AdlBundleRefType};
...
use crate::tsgen::tsgen;

// use super::*;

fn formatter(buf: &mut Formatter, record: &Record<'_>) -> io::Result<()> {
        ...
        Ok(tests) => {
            for t in &tests {
                ...
                let ts_opts = TypescriptGenOptions {
                    ...
                    outputs: Some(adl_core::adlgen::adlc::workspace::OutputOpts::Gen(GenOutput {
                    ...
                    ts_style: adl_core::adlgen::adlc::workspace::TsStyle::Tsc,
