...
pub fn decl(i: Input<'_>) -> Res<Input<'_>, adlast::Decl0> {
    let (i, annotations) = many0(prefix_annotation)(i)?;
    let ma = merge_annotations(annotations).map_err(|emsg| custom_error(i, emsg))?;
...
pub fn struct_(i: Input<'_>) -> Res<Input<'_>, (&str, adlast::Struct0)> {
...
pub fn union(i: Input<'_>) -> Res<Input<'_>, (&str, adlast::Union0)> {
...
pub fn field(i: Input<'_>) -> Res<Input<'_>, adlast::Field0> {
    context("field", field0)(i)
}

pub fn field0(i: Input<'_>) -> Res<Input<'_>, adlast::Field0> {
    let (i, annotations) = many0(prefix_annotation)(i)?;
    let ma = merge_annotations(annotations).map_err(|emsg| custom_error(i, emsg))?;
