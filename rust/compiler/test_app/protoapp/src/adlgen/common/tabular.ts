...
export interface Expr_Date {
  kind: 'date';
  value: common_types.LocalDate;
}
export interface Expr_Instant {
  kind: 'instant';
  value: common_types.Instant;
}
...
export interface ExprOpts {
  ...
  int: number;
  bool: boolean;
  date: common_types.LocalDate;
  instant: common_types.Instant;
  field: FieldName;
  currentDate: null;
  concat: Expr[];
}
