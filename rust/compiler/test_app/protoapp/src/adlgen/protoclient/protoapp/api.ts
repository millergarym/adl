...
import * as protoclient_protoapp_db from "../../protoclient/protoapp/db";
 ...
 */
  newMessage: common_http.HttpPost<NewMessageReq, common_types.Unit>;
/**
 * Get recent noticeboard messages
 */
  recentMessages: common_http.HttpPost<RecentMessagesReq, common_types.Paginated<Message>>;
/**
 ...
 */
  updateUser: common_http.HttpPost<common_db.WithDbId<UserReq>, common_types.Unit>;
/**
 * Delete an existing user
 */
  deleteUser: common_http.HttpPost<protoclient_protoapp_db.AppUserId, common_types.Unit>;
/**
 * Query existing users sorted and filters according to the
 * TableQuery request.
 */
  queryUsers: common_http.HttpPost<common_tabular.TableQuery, common_types.Paginated<common_db.WithDbId<protoclient_protoapp_db.AppUser>>>;
/**
 * Logs an error from the client app without user information, i.e. when the
 * user has not logged in
 */
  logClientErrorPublic: common_http.HttpPost<ClientLogReq, common_types.Unit>;
/**
 * Logs an error from the client app and includes user information
 */
  logClientErrorUser: common_http.HttpPost<ClientLogReq, common_types.Unit>;
}
...
export function makeApiRequests(
  ...
  return {
    ...
    newMessage: input.newMessage === undefined ? {path : "/messages/new", security : {kind : "token"}, rateLimit : null, reqType : texprNewMessageReq(), respType : common_types.texprUnit()} : input.newMessage,
    recentMessages: input.recentMessages === undefined ? {path : "/messages/recent", security : {kind : "token"}, rateLimit : null, reqType : texprRecentMessagesReq(), respType : common_types.texprPaginated(texprMessage())} : input.recentMessages,
    ...
    updateUser: input.updateUser === undefined ? {path : "/users/update", security : {kind : "tokenWithRole", value : "admin"}, rateLimit : null, reqType : common_db.texprWithDbId(texprUserReq()), respType : common_types.texprUnit()} : input.updateUser,
    deleteUser: input.deleteUser === undefined ? {path : "/users/delete", security : {kind : "tokenWithRole", value : "admin"}, rateLimit : null, reqType : protoclient_protoapp_db.texprAppUserId(), respType : common_types.texprUnit()} : input.deleteUser,
    queryUsers: input.queryUsers === undefined ? {path : "/users/query", security : {kind : "tokenWithRole", value : "admin"}, rateLimit : null, reqType : common_tabular.texprTableQuery(), respType : common_types.texprPaginated(common_db.texprWithDbId(protoclient_protoapp_db.texprAppUser()))} : input.queryUsers,
    logClientErrorPublic: input.logClientErrorPublic === undefined ? {path : "/client/log/public", security : {kind : "public"}, rateLimit : {maxRequests : 6, perTimeUnit : "minute"}, reqType : texprClientLogReq(), respType : common_types.texprUnit()} : input.logClientErrorPublic,
    logClientErrorUser: input.logClientErrorUser === undefined ? {path : "/client/log/user", security : {kind : "token"}, rateLimit : null, reqType : texprClientLogReq(), respType : common_types.texprUnit()} : input.logClientErrorUser,
  };
}

const ApiRequests_AST : ADL.ScopedDecl =
  {"moduleName":"protoclient.protoapp.api","decl":{"annotations":[],"type_":{"kind":"struct_","value":{"typeParams":[],"fields":[{"annotations":[],"serializedName":"x","default":{"kind":"nothing"},"name":"x","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"X"}},"parameters":[{"typeRef":{"kind":"primitive","value":"String"},"parameters":[]}]}},{"annotations":[],"serializedName":"imamap","default":{"kind":"nothing"},"name":"imamap","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"sys.types","name":"Map"}},"parameters":[{"typeRef":{"kind":"primitive","value":"String"},"parameters":[]},{"typeRef":{"kind":"primitive","value":"String"},"parameters":[]}]}},{"annotations":[],"serializedName":"with_prim","default":{"kind":"just","value":{"path":"/login","security":"public"}},"name":"with_prim","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"primitive","value":"String"},"parameters":[]},{"typeRef":{"kind":"primitive","value":"Vector"},"parameters":[{"typeRef":{"kind":"primitive","value":"StringMap"},"parameters":[{"typeRef":{"kind":"primitive","value":"Int64"},"parameters":[]}]}]}]}},{"annotations":[],"serializedName":"login","default":{"kind":"just","value":{"path":"/login","security":"public"}},"name":"login","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"LoginReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"LoginResp"}},"parameters":[]}]}},{"annotations":[],"serializedName":"newMessage","default":{"kind":"just","value":{"path":"/messages/new","security":"token"}},"name":"newMessage","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"NewMessageReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Unit"}},"parameters":[]}]}},{"annotations":[],"serializedName":"recentMessages","default":{"kind":"just","value":{"path":"/messages/recent","security":"token"}},"name":"recentMessages","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"RecentMessagesReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Paginated"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"Message"}},"parameters":[]}]}]}},{"annotations":[],"serializedName":"whoAmI","default":{"kind":"just","value":{"path":"/whoami","security":"token"}},"name":"whoAmI","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpGet"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"UserProfile"}},"parameters":[]}]}},{"annotations":[],"serializedName":"createUser","default":{"kind":"just","value":{"path":"/users/create","security":{"tokenWithRole":"admin"}}},"name":"createUser","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"UserReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.db","name":"AppUserId"}},"parameters":[]}]}},{"annotations":[],"serializedName":"updateUser","default":{"kind":"just","value":{"path":"/users/update","security":{"tokenWithRole":"admin"}}},"name":"updateUser","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"common.db","name":"WithDbId"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"UserReq"}},"parameters":[]}]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Unit"}},"parameters":[]}]}},{"annotations":[],"serializedName":"deleteUser","default":{"kind":"just","value":{"path":"/users/delete","security":{"tokenWithRole":"admin"}}},"name":"deleteUser","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.db","name":"AppUserId"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Unit"}},"parameters":[]}]}},{"annotations":[],"serializedName":"queryUsers","default":{"kind":"just","value":{"path":"/users/query","security":{"tokenWithRole":"admin"}}},"name":"queryUsers","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"common.tabular","name":"TableQuery"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Paginated"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"common.db","name":"WithDbId"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.db","name":"AppUser"}},"parameters":[]}]}]}]}},{"annotations":[],"serializedName":"logClientErrorPublic","default":{"kind":"just","value":{"path":"/client/log/public","rateLimit":{"maxRequests":6,"perTimeUnit":"minute"},"security":"public"}},"name":"logClientErrorPublic","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"ClientLogReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Unit"}},"parameters":[]}]}},{"annotations":[],"serializedName":"logClientErrorUser","default":{"kind":"just","value":{"path":"/client/log/user","security":"token"}},"name":"logClientErrorUser","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.http","name":"HttpPost"}},"parameters":[{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.api","name":"ClientLogReq"}},"parameters":[]},{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Unit"}},"parameters":[]}]}}]}},"name":"ApiRequests","version":{"kind":"nothing"}}};
...
const Message_AST : ADL.ScopedDecl =
  {"moduleName":"protoclient.protoapp.api","decl":{"annotations":[],"type_":{"kind":"struct_","value":{"typeParams":[],"fields":[{"annotations":[],"serializedName":"id","default":{"kind":"nothing"},"name":"id","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"protoclient.protoapp.db","name":"MessageId"}},"parameters":[]}},{"annotations":[],"serializedName":"postedAt","default":{"kind":"nothing"},"name":"postedAt","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.types","name":"Instant"}},"parameters":[]}},{"annotations":[],"serializedName":"userFullName","default":{"kind":"nothing"},"name":"userFullName","typeExpr":{"typeRef":{"kind":"primitive","value":"String"},"parameters":[]}},{"annotations":[],"serializedName":"message","default":{"kind":"nothing"},"name":"message","typeExpr":{"typeRef":{"kind":"reference","value":{"moduleName":"common.strings","name":"StringML"}},"parameters":[]}}]}},"name":"Message","version":{"kind":"nothing"}}};
